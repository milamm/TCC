...
public class InverseFFT {
	 ...
	 * 
	 * @param x
	 *            ComplexNumber array containing the input to the 1D inverse
	 *            FFT.
	...
	public int[] getPixels(TwoDArray output) {
		double[] outputArrayDoubles = new double[output.width * output.height];
		...
		outputArray = toPixels(allPositive(outputArrayDoubles));

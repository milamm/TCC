...
Além disto, porções fragmentadas da memória física podem ser alocadas para um processo, mas o gerenciador virtualiza estes fragmentos em um espaço contínuo de endereçamento, como ilustrado na Figura \ref{FIG:MEM_VIRTUAL}.

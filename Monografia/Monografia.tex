...
%
\newcommand{\titulo}{Sistema para Contagem Automática de Eritrócitos por Análise de Imagens de Amostras de Sangue}
\newcommand{\autor}{Mila Maracaba Moreira}
\newcommand{\orientador}{Prof. Dr. Paulo César Cortez}
\newcommand{\coorientador}{}
\newcommand{\membroa}{Prof. Dr. }
\newcommand{\membrob}{Prof. }
...
\include{chp3/metodologia}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAP\'{I}TULO 4: Resultados
\include{chp4/resultados}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% CAP\'{I}TULO 5: Conclusoes
\include{chp5/conclusoes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% APÊNDICE
%\appendix
%\begin{appendices}
%\include{apendice/marches}
%\end{appendices}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% INDICE REMISSIVO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

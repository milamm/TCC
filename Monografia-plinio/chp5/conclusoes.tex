...
Outros tipos de falhas podem ser modelados no sistema de inserção concebido, melhorando as estatísticas de cobertura de falhas dos algortimos.

A ferramenta foi planejada para que seja utilizada como parte de um sistema de diagnóstico para todo o conjunto de \emph{hardware} do computador. Diagnósticos para outros tipos de dispositivos podem ser reunidos em uma única aplicação, capaz de testar não apenas a memória, mas todo o sistema. 